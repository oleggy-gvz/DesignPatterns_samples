 ...
 * -----------------------
 * В методе PerformAction обработка команд в двух местах, отдельно для включения (иерархией классов ICommand) и отдельно отключения (внутри RemoteControl).
 * Т.е. класс RemoteControl жестко связан с иерархией классов ICommand.
 * Имеем отношение использования одного класса другим классом т.е. работаем на уровне реализации, а не интерфейса.
 * Еще нужно реализовать способ назначения команды на клавиши.
 *
 */
